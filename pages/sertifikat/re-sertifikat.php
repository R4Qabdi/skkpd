...
if(isset($_GET['act'])){
    ...
    if ($_GET['act']=="verif"){
        ...
        if($result){
            echo"alert('berhasil'); window.location.href='dashboard.php?page=re-sertifikat';";
        }
        ...
        <div class="tab-pane fade show active" id="panel1" role="tabpanel" aria-labelledby="tab1">
            ...
            <div class="card border-primary">
                <div class="card-body">
                    ...
                    <d name="" id="" class="btn btn-success"
                        href="dashboard.php?page=re-sertifikat&id=<?=$data['id_sertifikat']?>&act=verif" role="button">
                        Tandai sebagai Valid</a>
                        <a name="" id="" class="btn btn-success"
                            href="dashboard.php?page=re-sertifikat&id=<?=$data['id_sertifikat']?>&act=verif"
                            role="button">Tandai sebagai Tidak Valid</a>
                        <a name="" id="" class="btn btn-danger"
                            href="dashboard.php?page=re-sertifikat&id=<?=$data['id_sertifikat']?>&act=del"
